//document.domain = '172.17.44.250/TeleMedicine.WebAPI/';
...
var App = function () {
    ...
    //var cookiecolor = getCookie("ThemesColor");
    //var cookiecolor = $.cookie("ThemesColor");// { domain: 'instrumentsshare.com',path:'/' });
    //if (typeof (cookiecolor) != "undefined" && cookiecolor != null) {
    //    $('#style_color').attr("href", "/TeleMedicine.Web/Content/themes/css/style_" + cookiecolor + ".css");
    //}
    ...
    var handleMainMenu = function () {
        ...
        $(".sub > li  > a").click(function () {
            if ($(this).parent().find(".sub_Menu").length > 0) {
                if ($(this).parent().find(".sub_Menu").is(":visible")) {
                    ...
                    $(this).parent().find(".sub_arrow").removeClass("open");
                    $(this).parent().find(".sub_arrow").addClass("arrow_close");
                } else {
                    $(this).parent().find(".sub_Menu").slideDown(300);
                    $(this).parent().find(".sub_arrow").addClass("open");
                    $(this).parent().find(".sub_arrow").removeClass("arrow_close");
                }
            } else {
        ...
        $(" .sub_Menu_li").click(function () {
            $(".page-sidebar .has-sub").removeClass("active");
            $(" .sub_Menu_li").removeClass("active");
            $(this).addClass("active");
            $(this).parent().parent().parent().parent().addClass("active");
            if ($(this).find(".sub_Menu_li").is(":visible")) {
                $(this).find(".sub_Menu_li").slideUp(300);
                $(this).find(".sub_arrow").removeClass("open");
                $(this).find(".sub_arrow").addClass("arrow_close");
            } else {
                $(this).find(".sub_Menu_li").slideDown(300);
                $(this).find(".sub_arrow").addClass("open");
                $(this).find(".sub_arrow").removeClass("arrow_close");
            }
            $(".has-sub").removeClass("active");
            $(".sub_li").removeClass("active");
            $(this).parent().parent().parent().parent().addClass("active");
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            //document.cookie = "ThemesColor=" + escape(color);
            $.cookie("ThemesColor", color, { domain: 'instrumentsshare.com', path: '/', expires: 180 });
            $('#style_color').attr("href", "/InstrumentShare.Web/Content/themes/css/style_" + color + ".css");
        }
    ...
    var handleHeight = function () {
        $(".page-content").css({ "min-height": $(window).height() - 75 });
        $(window).resize(function () {
            $(".page-content").css({ "min-height": $(window).height() - 75 });
        });
    }
